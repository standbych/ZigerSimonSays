...
U8GLIB_SSD1306_128X64 DisplayController::display_u8g(U8G_I2C_OPT_NONE);
int DisplayController::display_currentPosition = -1;
...
void DisplayController::clear() {
  display_u8g.firstPage();
  while (display_u8g.nextPage())
    ;
}
...
void DisplayController::showTextS(const char* line1, const char* line2, const char* line3, const char* line4, const char* line5) {
  display_u8g.firstPage();
  do {
    display_currentPosition = -1;
    prepareHeader();
    if (line5 == nullptr) display_currentPosition += 4;
    writeLineS(line1);
    writeLineS(line2);
    writeLineS(line3);
    writeLineS(line4);
...
void DisplayController::showTextL(const char* line1, const char* line2, const char* line3) {
  ...
  do {
    display_currentPosition = -1;
    prepareHeader();
    if (line3 == nullptr) display_currentPosition += 8;
    writeLineL(line1);
    writeLineL(line2);
    writeLineL(line3);
  } while (display_u8g.nextPage());
...
void DisplayController::showTextXL(const char* line1, const char* line2) {
  ...
  do {
    display_currentPosition = -1;
    prepareHeader();
    display_currentPosition += 5;
    if (line2 == nullptr)
      display_currentPosition += 12;
    writeLineXL(line1);
    writeLineXL(line2);
  } while (display_u8g.nextPage());
}
...
void DisplayController::showTextXXL(const char* line1, const char* line2) {
  ...
  do {
    display_currentPosition = -1;
    prepareHeader();
    if (line2 == nullptr) display_currentPosition += 11;
    writeLineXXL(line1);
    writeLineXXL(line2);
  } while (display_u8g.nextPage());
}
